...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"team" | "outputs">("team");
  ...
  return (
    <div className="h-full flex flex-col gap-3 max-w-[1800px]">
      ...
      <div className="flex items-center gap-1 shrink-0">
        <TabButton active={activeTab === "team"} label="Team View" onClick={() => setActiveTab("team")} />
        <TabButton active={activeTab === "outputs"} label="Outputs" onClick={() => setActiveTab("outputs")} />
      </div>

      {/* Main content area */}
      {activeTab === "team" ? (
        /* Team View: Operations (GameWorld) + Chat Log — the classic layout */
        ...
        /* Outputs View: 2x2 grid of output panels */
